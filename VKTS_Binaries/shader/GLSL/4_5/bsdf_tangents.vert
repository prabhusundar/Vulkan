...
void main(void)
{
    ...
    v_f_bitangent = mat3(u_bufferViewProjection.viewMatrix) * u_bufferTransform.normalMatrix * a_bitangent;
    v_f_tangent = mat3(u_bufferViewProjection.viewMatrix) * u_bufferTransform.normalMatrix * a_tangent;
